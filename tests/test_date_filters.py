...
def app():
    ...
    with app.app_context():
        ...
        practice1 = Practice(id=1, season_id=1, date=date(2024, 1, 2), category='Official Practice')
        practice2 = Practice(id=2, season_id=1, date=date(2024, 1, 5), category='Official Practice')
