...
_GAME_CONFIG: Dict[str, ConfigMap] = {
    ...
    "contests_offense": {
        ...
        "column_map": {
            ...
            "FG%": ("fg3_pct",),
            "Contested 3FG": {
                "keys": ("fg3_contested_make", "fg3_contested_att"),
                "numeric_keys": ("fg3_contested_make",),
                "compose": "makes_attempts",
                "make_keys": ("fg3_contested_make",),
                "attempt_keys": ("fg3_contested_att",),
                "label": "3FG",
                "subgroup": "Contested 3's",
                "subgroup_header": "Contested",
            },
            "Contested 3FG %": {
                "keys": ("fg3_contested_pct",),
                "label": "3FG%",
                "subgroup": "Contested 3's",
                "subgroup_header": "Contested",
            },
            "Contested 3FG Freq": {
                "keys": ("fg3_contested_freq_pct",),
                "label": "3FG Freq",
                "subgroup": "Contested 3's",
                "format": "pct",
                "subgroup_header": "Contested",
            ...
            "Late Contest 3FG": {
                "keys": ("fg3_late_make", "fg3_late_att"),
                "numeric_keys": ("fg3_late_make",),
                "compose": "makes_attempts",
                "make_keys": ("fg3_late_make",),
                "attempt_keys": ("fg3_late_att",),
                "label": "3FG",
            ...
            "Uncontested 3FG": {
                "keys": ("fg3_uncontested_make", "fg3_uncontested_att"),
                "numeric_keys": ("fg3_uncontested_make",),
                "compose": "makes_attempts",
                "make_keys": ("fg3_uncontested_make",),
                "attempt_keys": ("fg3_uncontested_att",),
                "label": "3FG",
                "subgroup": "Uncontested 3's",
                "subgroup_header": "Uncontested",
            },
            "Uncontested 3FG %": {
                "keys": ("fg3_uncontested_pct",),
                "label": "3FG%",
                "subgroup": "Uncontested 3's",
                "subgroup_header": "Uncontested",
            },
            "Uncontested 3FG Freq": {
                "keys": ("fg3_uncontested_freq_pct",),
                "label": "3FG Freq",
                "subgroup": "Uncontested 3's",
                "format": "pct",
                "subgroup_header": "Uncontested",
        ...
        "table_id": "game-leaderboard-offense-3fg-contests",
        "percent_specs": [
            {
                "slug": "fg_pct",
                "metric": "fg3_pct",
            ...
            },
            {
                ...
                "minimum_slugs": [
                    "fg3_contested_min",
                    "fg3_contested_min_att",
                    "fg3_contested_min_attempts",
                    "contested_min",
                    "contested_min_att",
                    "contested_min_attempts",
                ],
            },
            {
                "slug": "late_contest_3fg_pct",
                "metric": "fg3_pct",
                "attempt_slugs": [
                    "fg3_late_att",
                    "late_att",
            ...
            {
                "slug": "uncontested_3fg_pct",
                "metric": "fg3_pct",
                "attempt_slugs": [
                    "fg3_uncontested_att",
                    "uncontested_att",
                    "uncontested_attempts",
                ],
                "minimum_slugs": [
                    "fg3_uncontested_min",
                    "fg3_uncontested_min_att",
                    "fg3_uncontested_min_attempts",
                    "uncontested_min",
                    "uncontested_min_att",
                    "uncontested_min_attempts",
                ],
            },
        ],
    },
