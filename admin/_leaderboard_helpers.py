...
def _flatten_contest_totals(totals: Any, prefixes: Sequence[str]) -> Any:
    """Return totals mapping with contest breakdown flattened."""
    ...
    for prefix in prefixes:
        entry = totals.get(prefix)
        if not isinstance(entry, Mapping):
            continue
        plus = entry.get("plus")
        opps = entry.get("opps")
        pct = entry.get("pct")
        flattened[f"{prefix}_makes"] = plus
        flattened[f"{prefix}_plus"] = plus
        flattened[f"{prefix}_attempts"] = opps
        flattened[f"{prefix}_opps"] = opps
        flattened[f"{prefix}_pct"] = pct

    return flattened or totals
...
def build_leaderboard_table(
    *,
    ...
    contest_breakdown_keys = {
        "atr_contest_breakdown",
        "fg2_contest_breakdown",
        "fg3_contest_breakdown",
    }
    if stat_key in contest_breakdown_keys:
        team_totals = _flatten_contest_totals(team_totals, ("contest", "late", "no_contest"))
    ...
    if stat_key == "assist_summary":
        ...
        column_specs.extend(
            [
                _spec(
                    "Crash +",
                    keys=("crash_plus", "crash_positive", "plus"),
                    index=1,
                    fmt="int",
                    default=True,
                    default_order=2,
                ...
                _spec(
                    "Crash Att",
                    keys=("crash_att", "crash_opp", "crash_opps", "opps"),
                    index=2,
                    fmt="int",
                    default=True,
                    default_order=1,
                ...
                _spec(
                    "Back Man %",
                    keys=("back_man_pct", "back_pct", "pct"),
                    index=6,
                    fmt="pct",
                ),
            ]
        ...
        column_specs.extend(
            [
                _spec(
                    "Box Out +",
                    keys=("box_plus", "box_out_positive", "plus"),
                    index=1,
                    fmt="int",
                    default=True,
                    default_order=2,
                ...
                _spec(
                    "Off Reb's Given Up",
                    keys=("off_reb_given_up", "given_up"),
                    index=4,
                    fmt="int",
                ),
            ]
        ...
        column_specs.extend(
            [
                _spec(
                    "Gap +",
                    keys=("gap_plus", "collision_gap_positive", "plus"),
                    index=1,
                    fmt="int",
                    default=True,
                    default_order=2,
                ...
                _spec(
                    "Gap Opp",
                    keys=("gap_opp", "gap_opps", "collision_gap_opps", "opps"),
                    index=2,
                    fmt="int",
                    default=True,
                    default_order=1,
                ...
                _spec(
                    "Gap %",
                    keys=("gap_pct", "collision_gap_pct", "pct"),
                    index=3,
                    fmt="pct",
                    default=True,
                    default_order=0,
                ...
                _spec(
                    "Low +",
                    keys=("low_plus", "low_help_positive", "plus"),
                    index=4,
                    fmt="int",
                ),
                _spec(
                    "Low Opp",
                    keys=("low_opp", "low_opps", "low_help_opps", "opps"),
                    index=5,
                    fmt="int",
                ),
                _spec(
        ...
        column_specs.extend(
            [
                _spec(
                    "Contest +",
                    keys=("contest_plus", "pass_contest_plus", "plus"),
                    index=1,
                    fmt="int",
                    default=True,
                    default_order=2,
                ...
                _spec(
                    "Contest %",
                    keys=("contest_pct", "pass_contest_pct", "pct"),
                    index=3,
                    fmt="pct",
                    default=True,
                    default_order=0,
        ...
        column_specs.extend(
            [
                _spec(
                    "Gap +",
                    keys=("gap_plus", "pnr_gap_positive", "plus"),
                    index=1,
                    fmt="int",
                    default=True,
                    default_order=2,
                ...
                _spec(
                    "Gap Opp",
                    keys=("gap_opp", "gap_opps", "pnr_gap_opps", "opps"),
                    index=2,
                    fmt="int",
                    default=True,
                    default_order=1,
        ...
        column_specs.extend(
            [
                _spec(
                    "Close Window +",
                    keys=("cw_plus", "close_window_plus", "close_window_positive", "plus"),
                    index=1,
                    fmt="int",
                    default=True,
                    default_order=2,
                ...
                _spec(
                    "Close Window %",
                    keys=("cw_pct", "close_window_pct", "pct"),
                    index=3,
                    fmt="pct",
                    default=True,
                    default_order=0,
                ...
                _spec(
                    "Shut Door +",
                    keys=("sd_plus", "shut_door_plus", "shut_door_positive", "plus"),
                    index=4,
                    fmt="int",
                ),
                _spec(
                ...
                _spec(
                    "Shut Door %",
                    keys=("sd_pct", "shut_door_pct", "pct"),
                    index=6,
                    fmt="pct",
                ),
            ]
        )
    elif stat_key in contest_breakdown_keys:
        prefix = stat_key.split("_", 1)[0]
        column_specs.extend(
            [
                _spec(
                    "Contest Att",
                    keys=(
                        ...
                        "contest_attempts",
                        "contest_opps",
                        f"{prefix}_contest_attempts",
                        f"{prefix}_contest_opps",
                        "opps",
                    ),
                    fmt="int",
                    default=True,
                ...
                _spec(
                    ...
                    keys=(
                        "contest_makes",
                        "contest_plus",
                        f"{prefix}_contest_makes",
                        f"{prefix}_contest_plus",
                        "plus",
                    ),
                    fmt="int",
                    default=True,
                ...
                _spec(
                    "Late FG%",
                    keys=("late_pct", f"{prefix}_late_pct", "pct"),
                    fmt="pct",
                ),
                _spec(
                    "No Contest Att",
                    keys=(
                        ...
                        "no_contest_attempts",
                        "no_contest_opps",
                        f"{prefix}_no_contest_attempts",
                        f"{prefix}_no_contest_opps",
                        "opps",
                    ),
                    fmt="int",
                ),
                _spec(
                    ...
                    keys=(
                        "no_contest_makes",
                        "no_contest_plus",
                        f"{prefix}_no_contest_makes",
                        f"{prefix}_no_contest_plus",
                        "plus",
                    ),
                    fmt="int",
                ),
                _spec(
                    "No Contest FG%",
                    keys=("no_contest_pct", f"{prefix}_no_contest_pct", "pct"),
                    fmt="pct",
                ),
            ]
        )
